...
if __name__ == "__main__":
		...
		for s_dB in snr_dB:
			...
			for I_a in I_a_range:
				if export==True: # if export if false, we already have these values.
					...
					E = calc_E(X, I_a, s_dB, sparcparams, csv_filename='E_data_L512_M512_r0_877_p1_8_10reps_500bins_3.csv')#'E_data_L768_M512_r0_877_p1_8_10reps_250bins.csv')
				else:
	...
	plt.savefig('amp_exitchart_L512_M512_10reps_500bins_3.png')	
	#plt.show()

...
if __name__ == "__main__":
    ...
    waterfall(sparcparams, ldpcparams, datapoints=15, MIN_ERRORS=100, MAX_BLOCKS=150, csv_filename='EbN0_dBVsBER_waterfall_minrep100.csv', png_filename='EbN0_dBVsBER_waterfall_minrep100.png')
